...
# c0d49d2841624912bfc19bf5d958c47f
...
class Analyzer347 :
    ...
    def isValid(
        ...
        if not (messagesClient[13]["sender"] == "bot" and messagesClient[13]["message"].startswith("O valor mínimo é de R$0.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar o")):
            return False
