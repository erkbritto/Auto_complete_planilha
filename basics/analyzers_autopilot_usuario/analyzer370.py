...
# 2453eb20462040038cc1d5abccafb71e
...
class Analyzer370 :
    ...
    def isValid(
        ...
        if not (messagesClient[13]["sender"] == "bot" and messagesClient[13]["message"].startswith("Desculpe, não entendi sua solicitação, por favor, tente novamente Digite:\n\n1 - Dificuldade em efet")):
            return False
        ...
        if not (messagesClient[19]["sender"] == "bot" and messagesClient[19]["message"].startswith("nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento e o *documento ")):
            return False
