...
# ccf99bb9317344bb902a85bc02f6dcad
...
class Analyzer266 :
    ...
    def isValid(
        ...
        if not (messagesClient[25]["sender"] == "bot" and messagesClient[25]["message"].startswith("Para registrar elogios, sugestões ou reclamações, acesso o nosso site www.niodigital.com.br e efetue")):
            return False
