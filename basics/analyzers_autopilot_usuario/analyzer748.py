...
# 972eb86cfabe404f947f8055fcee7435
...
class Analyzer748 :
    ...
    def isValid(
        ...
        if not (messagesClient[15]["sender"] == "bot" and messagesClient[15]["message"].startswith("Cartão desbloqueado com sucesso.\n💻 Acesse o nosso site e cadastre a sua senha:\nhttps://niodigital.")):
            return False
        ...
        if not (messagesClient[27]["sender"] == "bot" and messagesClient[27]["message"].startswith("Tudo bem!\nNio Digital agradece e até logo!")):
            return False
