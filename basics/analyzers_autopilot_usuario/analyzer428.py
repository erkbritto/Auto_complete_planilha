...
# 51a6a64f01694db78b1ff4110bbe31b7
...
class Analyzer428 :
    ...
    def isValid(
        ...
        if not (messagesClient[17]["sender"] == "bot" and messagesClient[17]["message"].startswith("O valor mínimo é de R$0.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar o")):
            return False
