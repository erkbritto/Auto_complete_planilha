...
# 13f37735252f484d85b3c7eaf6c309c0
...
class Analyzer927 :
    ...
    def isValid(
        ...
        if not (messagesClient[37]["sender"] == "bot" and messagesClient[37]["message"].startswith("O valor mínimo é de")):
            return False
        ...
        if not (messagesClient[41]["sender"] == "bot" and messagesClient[41]["message"].startswith("Tudo bem!\nNio Digital agradece e até logo!")):
            return False
