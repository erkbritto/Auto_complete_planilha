...
# 9f1e38f4461547cfa451d0a39270090f
...
class Analyzer440 :
    ...
    def isValid(
        ...
        if not (messagesClient[29]["sender"] == "bot" and messagesClient[29]["message"].startswith("Você já fez o download do nosso aplicativo NIO Digital📲? \nNele, você pode verificar o limite, consu")):
            return False
    
        if not (messagesClient[31]["sender"] == "bot" and messagesClient[31]["message"].startswith("Tudo bem!\nNio Digital agradece e até logo!")):
            return False
