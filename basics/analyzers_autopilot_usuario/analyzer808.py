...
# 64cd51892915409994058ec8b4e12f70
...
class Analyzer808 :
    ...
    def isValid(
        ...
        if not (messagesClient[23]["sender"] == "bot" and messagesClient[23]["message"].startswith("Nesse caso, você deverá aguardar a compensação bancária de 3 a 5 dias úteis. ㅤ\nTe ajudo em algo mai")):
            return False
