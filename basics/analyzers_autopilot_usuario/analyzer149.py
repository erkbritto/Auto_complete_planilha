...
# 71a81d6fcb4d472f88e1e957a302aa4f
...
class Analyzer149 :
    ...
    def isValid(
        ...
        if not (messagesClient[21]["sender"] == "bot" and messagesClient[21]["message"].startswith("Cartão desbloqueado com sucesso.\n💻 Acesse o nosso site e cadastre a sua senha:\nhttps://niodigital.")):
            return False
        ...
        if not (messagesClient[25]["sender"] == "bot" and messagesClient[25]["message"].startswith("Tudo bem!\nNio Digital agradece e até logo!")):
            return False
