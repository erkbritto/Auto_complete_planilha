...
# d02aa42932594da68ceb79995bcf46bc
...
class Analyzer316 :
    ...
    def isValid(
        ...
        if not (messagesClient[7]["sender"] == "bot" and messagesClient[7]["message"].startswith("Nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento *o comprovante ")):
            return False
        ...
        if not (messagesClient[17]["sender"] == "bot" and messagesClient[17]["message"].startswith("Nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento *o comprovante ")):
            return False
        ...
        if not (messagesClient[23]["sender"] == "bot" and messagesClient[23]["message"].startswith("O últimos 4 dígitos que você digitou está inválido ou não foi possível consultar o limite. Por favor")):
            return False
