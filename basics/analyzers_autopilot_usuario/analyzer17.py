...
# 3bc195562bfb44dea73be2331bdec365
...
class Analyzer17 :
    ...
    def isValid(
        ...
        if not (messagesClient[11]["sender"] == "bot" and messagesClient[11]["message"].startswith("O limite do seu cartão é calculado conforme sua margem disponível. \nPara solicitar o aumento de lim")):
            return False
