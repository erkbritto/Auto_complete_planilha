...
# a23f9f9b4e9e4c5e8cea302f9cd9167a
...
class Analyzer503 :
    ...
    def isValid(
        ...
        if not (messagesClient[5]["sender"] == "bot" and messagesClient[5]["message"].startswith("Desculpe não entendi. Retornaremos para o início.\n\n")):
            return False
    
        if not (messagesClient[7]["sender"] == "bot" and messagesClient[7]["message"].startswith("Desculpe não entendi. Retornaremos para o início.\n\n")):
            return False
