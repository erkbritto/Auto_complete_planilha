...
# 4a20e8e6b84046eeb1a2b2faac790ff1
...
class Analyzer763 :
    ...
    def isValid(
        ...
        if not (messagesClient[25]["sender"] == "bot" and messagesClient[25]["message"].startswith("Olha, no momento não consta pagamento em nosso sistema.\nPeço que nos envie seu nome completo, CPF, ")):
            return False
