...
# 73e5c987adae4ae5b959bfb509bdabac
...
class Analyzer651 :
    ...
    def isValid(
        ...
        if not (messagesClient[11]["sender"] == "bot" and messagesClient[11]["message"].startswith("O valor mínimo descontado no contracheque corresponde à sua margem consignável reservada para a NIO ")):
            return False
        ...
        if not (messagesClient[25]["sender"] == "bot" and messagesClient[25]["message"].startswith("Nesse caso, você deverá aguardar a compensação bancária de 3 a 5 dias úteis. ㅤ\nTe ajudo em algo mai")):
            return False
