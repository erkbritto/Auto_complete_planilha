...
# 5f354a2cbb1444b9a8096e2a26165994
...
class Analyzer644 :
    ...
    def isValid(
        ...
        if not (messagesBot[33]["sender"] == "bot" and messagesBot[33]["message"].startswith("Aqui está a sua última fatura disponível:\n\nhttps://storage.googleapis.com/bucktgwtalkdesknio/6030b")):
            return False
