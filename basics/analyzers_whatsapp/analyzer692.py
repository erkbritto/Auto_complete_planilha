...
# e051b523e4e74a2fbe4f851db0e41258
...
class Analyzer692 :
    ...
    def isValid(
        ...
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("Não foi possível consultar a sua ultima fatura, a mesma se encontra indisponível no momento.\nㅤ ㅤ\nT")):
            return False
        ...
        if not (messagesBot[25]["sender"] == "bot" and messagesBot[25]["message"].startswith("Seja bem-vindo(a) à Nio Digital!\n\nSou o Alê, seu assistente virtual.\n\nPara obter informações sob")):
            return False
