...
# d9412ba45caf4458ab84d8e2efa15bbd
...
class Analyzer291 :
    ...
    def isValid(
        ...
        if not (messagesBot[19]["sender"] == "bot" and messagesBot[19]["message"].startswith("O valor mínimo é de R$0.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar o")):
            return False
        ...
        if not (messagesBot[25]["sender"] == "bot" and messagesBot[25]["message"].startswith("Devido a um problema técnico na geração das faturas, estamos excepcionalmente recebendo os pagamento")):
            return False
