...
# 58397de266c8416ebbb19691c42ce33e
...
class Analyzer941 :
    ...
    def isValid(
        ...
        if not (messagesBot[17]["sender"] == "bot" and messagesBot[17]["message"].startswith("O valor mínimo é de R$129.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar")):
            return False
