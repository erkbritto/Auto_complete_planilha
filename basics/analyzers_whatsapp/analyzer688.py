...
# a1fc6a8f5e884ad18c4d300d37dcdf1e
...
class Analyzer688 :
    ...
    def isValid(
        ...
        if not (messagesBot[15]["sender"] == "bot" and messagesBot[15]["message"].startswith("Nesse caso, você deverá aguardar a compensação bancária de 3 a 5 dias úteis. ㅤ\nTe ajudo em algo mai")):
            return False
