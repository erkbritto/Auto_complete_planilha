...
# 2ef445c1d1fe401096d987319cb86e2e
...
class Analyzer718 :
    ...
    def isValid(
        ...
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("O valor mínimo descontado no contracheque corresponde à sua margem consignável reservada para a NIO ")):
            return False
