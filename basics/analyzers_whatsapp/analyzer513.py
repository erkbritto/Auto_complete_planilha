...
# 905b538b5e1542abbf6291a8cf49e826
...
class Analyzer513 :
    ...
    def isValid(
        ...
        if not (messagesBot[15]["sender"] == "bot" and messagesBot[15]["message"].startswith("O valor mínimo é de R$144.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar")):
            return False
    
        if not (messagesBot[17]["sender"] == "bot" and messagesBot[17]["message"].startswith("Aqui está a sua última fatura disponível:\n\nhttps://storage.googleapis.com/bucktgwtalkdesknio/720df")):
            return False
        ...
        if not (messagesBot[23]["sender"] == "bot" and messagesBot[23]["message"].startswith("Nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento *o comprovante ")):
            return False
