...
# e78dd19d7de74b34964cac2b93167596
...
class Analyzer517 :
    ...
    def isValid(
        ...
        if not (messagesBot[7]["sender"] == "bot" and messagesBot[7]["message"].startswith("Para registrar elogios, sugestões ou reclamações, acesso o nosso site www.niodigital.com.br e efetue")):
            return False
