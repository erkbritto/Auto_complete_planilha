...
# a516037d5f4249939a7eadc8ba29a97b
...
class Analyzer642 :
    ...
    def isValid(
        ...
        if not (messagesBot[9]["sender"] == "bot" and messagesBot[9]["message"].startswith("O valor mínimo é de R$212.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar")):
            return False
