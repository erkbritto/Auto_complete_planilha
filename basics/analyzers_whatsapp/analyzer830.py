...
# 50bfd2921d134e7eaedb76283c2d7b8d
...
class Analyzer830 :
    ...
    def isValid(
        ...
        if not (messagesBot[11]["sender"] == "bot" and messagesBot[11]["message"].startswith("O valor mínimo é de R$82.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar ")):
            return False
        ...
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("Por favor aguarde um instante enquanto processamos sua solicitação.")):
            return False
        ...
        if not (messagesBot[31]["sender"] == "bot" and messagesBot[31]["message"].startswith("Aguarde um instante enquanto lhe transferimos a um de nossos atendentes.")):
            return False
