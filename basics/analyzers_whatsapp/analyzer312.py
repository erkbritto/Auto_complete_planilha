...
# 3d7ef595d17e46d9acb15e870bb0d874
...
class Analyzer312 :
    ...
    def isValid(
        ...
        if not (messagesBot[25]["sender"] == "bot" and messagesBot[25]["message"].startswith("Você já fez o download do nosso aplicativo NIO Digital📲? \nNele, você pode verificar o limite, consu")):
            return False
