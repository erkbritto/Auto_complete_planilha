...
# 5b5dcf38280f4d80b0e9cc3c6f4fd7a0
...
class Analyzer44 :
    ...
    def isValid(
        ...
        if not (messagesBot[11]["sender"] == "bot" and messagesBot[11]["message"].startswith("Por favor aguarde um instante enquanto processamos sua solicitação.\n\nㅤ Não há transações disponíve")):
            return False
        ...
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("Tivemos um problema com o seu atendimento. Vamos lá, vamos começar novamente. *Digite a opção deseja")):
            return False
        ...
        if not (messagesBot[31]["sender"] == "bot" and messagesBot[31]["message"].startswith("")):
            return False
