...
# 84902c493c724a27b5fffa7eb5429239
...
class Analyzer472 :
    ...
    def isValid(
        ...
        if not (messagesBot[31]["sender"] == "bot" and messagesBot[31]["message"].startswith("Aqui está a sua última fatura disponível:\n\nhttps://storage.googleapis.com/bucktgwtalkdesknio/88408")):
            return False
