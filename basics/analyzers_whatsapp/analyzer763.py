...
# 50db23c11bc9489e80b0e8f7383dad04
...
class Analyzer763 :
    ...
    def isValid(
        ...
        if not (messagesBot[23]["sender"] == "bot" and messagesBot[23]["message"].startswith("O Mastercard® Surpreenda é o programa de benefícios da Mastercard que oferece 1 ponto a cada compra ")):
            return False
