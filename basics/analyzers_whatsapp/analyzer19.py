...
# 5845ea2937b148b7ac1ac678dd810df1
...
class Analyzer19 :
    ...
    def isValid(
        ...
        if not (messagesBot[9]["sender"] == "bot" and messagesBot[9]["message"].startswith("Só um momento que vou transferir para um dos nossos especialistas que irá lhe auxiliar com sua solic")):
            return False
