...
# d932e4999605489bbafe88561dc3ffbc
...
class Analyzer55 :
    ...
    def isValid(
        ...
        if not (messagesBot[13]["sender"] == "bot" and messagesBot[13]["message"].startswith("No momento não conseguimos realizar o desbloqueio do seu cartão, mas não se preocupe, estou vou tran")):
            return False
