...
# 952a90728e65464eb4934bfeb8d94d08
...
class Analyzer745 :
    ...
    def isValid(
        ...
        if not (messagesBot[23]["sender"] == "bot" and messagesBot[23]["message"].startswith("Não conseguimos localizar o CPF informado, digite-o novamente, mas apenas os números, ok?")):
            return False
        ...
        if not (messagesBot[31]["sender"] == "bot" and messagesBot[31]["message"].startswith("Devido a um problema técnico na geração das faturas, estamos excepcionalmente recebendo os pagamento")):
            return False
