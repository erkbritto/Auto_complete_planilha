...
# bd69251fdb1242a585ee6b248f8291dd
...
class Analyzer295 :
    ...
    def isValid(
        ...
        if not (messagesBot[15]["sender"] == "bot" and messagesBot[15]["message"].startswith("Para cadastrar a senha do seu cartão acesse o site https://niodigital.com.br/, no menu Área do Clien")):
            return False
        ...
        if not (messagesBot[27]["sender"] == "bot" and messagesBot[27]["message"].startswith("No momento não conseguimos realizar o desbloqueio do seu cartão, mas não se preocupe, estou vou tran")):
            return False
