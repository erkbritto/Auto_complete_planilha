...
# 84033e190fed4f83a9b491cc068082ea
...
class Analyzer180 :
    ...
    def isValid(
        ...
        if not (messagesBot[19]["sender"] == "bot" and messagesBot[19]["message"].startswith("O valor mínimo é de R$44.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar ")):
            return False
    
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("Encontramos uma dificuldade em entender a sua solicitação. Vou transferir para um especialista. Por ")):
            return False
