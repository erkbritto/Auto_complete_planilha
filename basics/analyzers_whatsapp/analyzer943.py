...
# c282c90f79df46b7b243d19c95245fa4
...
class Analyzer943 :
    ...
    def isValid(
        ...
        if not (messagesBot[15]["sender"] == "bot" and messagesBot[15]["message"].startswith("O valor mínimo é de R$150.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar")):
            return False
    
        if not (messagesBot[17]["sender"] == "bot" and messagesBot[17]["message"].startswith("ㅤ\nTe ajudo em algo mais? (Sim ou Não)")):
            return False
