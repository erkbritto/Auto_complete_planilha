...
# c0fe3229ad474cc0b891a7bc9a417d7d
...
class Analyzer922 :
    ...
    def isValid(
        ...
        if not (messagesBot[9]["sender"] == "bot" and messagesBot[9]["message"].startswith("*Digite a opção desejada para atualização*:\n\n1 - E-mail\n2 - Nome\n3 - Endereço\n4 - RG\n5 - Telef")):
            return False
    
        if not (messagesBot[11]["sender"] == "bot" and messagesBot[11]["message"].startswith("Nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento *o comprovante ")):
            return False
