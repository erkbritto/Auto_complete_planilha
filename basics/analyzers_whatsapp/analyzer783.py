...
# 2146e78608d44544ba309a807e3bec9b
...
class Analyzer783 :
    ...
    def isValid(
        ...
        if not (messagesBot[13]["sender"] == "bot" and messagesBot[13]["message"].startswith("O seu código de rastreio é o")):
            return False
    
        if not (messagesBot[15]["sender"] == "bot" and messagesBot[15]["message"].startswith("*Digite a opção desejada para*:\n\n1 - Limite disponível para utilização\n2 - Informações sobre a su")):
            return False
    
        if not (messagesBot[17]["sender"] == "bot" and messagesBot[17]["message"].startswith("O seu código de rastreio é o")):
            return False
