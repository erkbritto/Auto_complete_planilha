...
# 0bbd2486f94b44ac8ee05705639f1895
...
class Analyzer246 :
    ...
    def isValid(
        ...
        if not (messagesBot[19]["sender"] == "bot" and messagesBot[19]["message"].startswith("Olha, no momento não consta pagamento em nosso sistema.\nPeço que nos envie seu nome completo, CPF, ")):
            return False
