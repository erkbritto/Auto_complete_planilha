...
# 98ba062318a84ae59a2e63d525a02437
...
class Analyzer269 :
    ...
    def isValid(
        ...
        if not (messagesBot[7]["sender"] == "bot" and messagesBot[7]["message"].startswith("Nesse caso, peço que nos envie seu nome completo, CPF, o protocolo deste atendimento e o *documento ")):
            return False
