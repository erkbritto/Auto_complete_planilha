...
# 6ae12ec330d048afae2e263ccf0b6cd5
...
class Analyzer569 :
    ...
    def isValid(
        ...
        if not (messagesBot[23]["sender"] == "bot" and messagesBot[23]["message"].startswith("Por favor aguarde um instante enquanto processamos sua solicitação.")):
            return False
        ...
        if not (messagesBot[31]["sender"] == "bot" and messagesBot[31]["message"].startswith("Não foi possível consultar a sua ultima fatura, a mesma se encontra indisponível no momento.\nㅤ ㅤ\nT")):
            return False
