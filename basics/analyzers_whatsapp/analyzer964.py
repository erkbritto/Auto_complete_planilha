...
# c3063f2d05724921a93348d4c2b6922b
...
class Analyzer964 :
    ...
    def isValid(
        ...
        if not (messagesBot[27]["sender"] == "bot" and messagesBot[27]["message"].startswith("Desculpe, não entendi sua solicitação, por favor, tente novamente Digite:\n\n1 - Dificuldade em efet")):
            return False
