...
# 1730a9149d864229aad2e884efba582f
...
class Analyzer738 :
    ...
    def isValid(
        ...
        if not (messagesBot[9]["sender"] == "bot" and messagesBot[9]["message"].startswith("O valor mínimo é de R$157.00, e será descontado automaticamente em folha de pagamento.\nPara efetuar")):
            return False
        ...
        if not (messagesBot[21]["sender"] == "bot" and messagesBot[21]["message"].startswith("Devido a um problema técnico na geração das faturas, estamos excepcionalmente recebendo os pagamento")):
            return False
        ...
        if not (messagesBot[27]["sender"] == "bot" and messagesBot[27]["message"].startswith("Só um momento enquanto te transferimos para um de nossos agentes.")):
            return False
