...
# 844d9d1f7ea54c508eeb294df246c39c
...
class Analyzer368 :
    ...
    def isValid(
        ...
        if not (messagesBot[33]["sender"] == "bot" and messagesBot[33]["message"].startswith("No momento não conseguimos realizar o desbloqueio do seu cartão, mas não se preocupe, estou vou tran")):
            return False
