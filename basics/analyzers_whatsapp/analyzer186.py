...
# 72cee14597c848d7916764a044507744
...
class Analyzer186 :
    ...
    def isValid(
        ...
        if not (messagesBot[7]["sender"] == "bot" and messagesBot[7]["message"].startswith("Para atualização do telefone, peço que nos envie seu nome completo, CPF, o protocolo deste atendimen")):
            return False
        ...
        if not (messagesBot[19]["sender"] == "bot" and messagesBot[19]["message"].startswith("Cartão desbloqueado com sucesso.\n💻 Acesse o nosso site e cadastre a sua senha:\nhttps://niodigital.")):
            return False
