...
# 169388eec0b94eb4bfd5a6681f60e3c9
...
class Analyzer988 :
    ...
    def isValid(
        ...
        if not (messagesBot[25]["sender"] == "bot" and messagesBot[25]["message"].startswith("Nesse caso, você deverá aguardar a compensação bancária de 3 a 5 dias úteis. ㅤ\nTe ajudo em algo mai")):
            return False
